  ...
  },
  {
    ...
    icon: (
      <svg className="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M15 9v1m0 4v1m-6-6v1m0 4v1" />
      </svg>
    ),
  },
  {
...
export default function PanelSidebar({ isOpen, isMobile, onClose, onToggle, user }: PanelSidebarProps) {
  ...
  const navContent = (
    <div className="flex flex-col h-full w-60 bg-surface-1 border-r border-border-default">
      {/* Logo */}
      <Link href="/admin" className="flex items-center gap-2 px-5 pt-6 pb-8" onClick={isMobile ? onClose : undefined}>
        <img src="/images/psi-logo-nav.png" alt="PSI Panel" className="h-8 w-auto" />
      ...
      <div className="px-3 pb-4">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full flex items-center gap-2 px-3 py-2.5 mt-3 rounded-lg text-[12px] text-text-muted hover:text-red-400 hover:bg-red-500/10 transition-all"
        >
